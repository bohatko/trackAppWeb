...
import 'more_orders_z_model.dart';
export 'more_orders_z_model.dart';

class MoreOrdersZWidget extends StatefulWidget {
  const MoreOrdersZWidget({
    super.key,
  ...
  static String routeName = 'MoreOrders_Z';
  static String routePath = 'moreOrdersZ';

  @override
  State<MoreOrdersZWidget> createState() => _MoreOrdersZWidgetState();
}

class _MoreOrdersZWidgetState extends State<MoreOrdersZWidget> {
  late MoreOrdersZModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MoreOrdersZModel());
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        '${containerOrdersRecord.orderPrice.toString()} ₽',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              fontFamily: 'Roboto',
                                    ...
                                    child: Container(
                                      ...
                                      child: StreamBuilder<List<OffersRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<OffersRecord>
                                              columnOffersRecordList =
                                              snapshot.data!;
                                          final columnOffersRecord =
                                              columnOffersRecordList.isNotEmpty
                                                  ? columnOffersRecordList.first
                                                  : null;
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                TextSpan(
                                                                                  text: valueOrDefault<String>(
                                                                                    columnOffersRecord?.gosNomer,
                                                                                    'не назначена техника',
                                                                                  ),
                                                                                  style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                        fontFamily: 'Roboto',
                                                            ...
                                                            builder: (context,
                                                              ...
                                                              return Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  if ((columnDocsRecord?.docEsm2 !=
                                                                              null &&
                                                                          columnDocsRecord?.docEsm2 !=
                                                                              '') &&
                                                                      (containerOrdersRecord
                                                                              .needDoc ==
                                                                          true))
                                                                  ...
                                                                  if ((columnDocsRecord?.docEsm7 !=
                                                                              null &&
                                                                          columnDocsRecord?.docEsm7 !=
                                                                              '') &&
                                                                      (containerOrdersRecord
                                                                              .needDoc ==
                                                                          true))
                                                              ...
                                                              padding:
                                                                  EdgeInsets
                                                                      .all(
                                                                          12.0),
                                                              child: Text(
                                                                'Мы подбираем для вас технику, это может занять какое то время. Как только найдется исполнитель, мы пришлём уведомление.',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
