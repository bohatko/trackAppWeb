...
class LoginSmsWidget extends StatefulWidget {
  ...
  final DocumentReference? assignUser;

  static String routeName = 'login_sms';
  static String routePath = 'loginSms';

  @override
  State<LoginSmsWidget> createState() => _LoginSmsWidgetState();
}
...
class _LoginSmsWidgetState extends State<LoginSmsWidget> {
  ...
  void initState() {
    ...
    _model.textField121212TextController ??= TextEditingController(
        text: widget!.number != null && widget!.number != ''
            ? widget!.number
            : '');
    _model.textField121212FocusNode ??= FocusNode();
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.textField121212TextController,
                                focusNode: _model.textField121212FocusNode,
                                ...
                                validator: _model
                                    ...
                                    .asValidator(context),
                                inputFormatters: [_model.textField121212Mask],
                              ),
                            ),
                          ),
                        ],
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              _model.apiResultm0g = await SmsAuthCall.call(
                                to: '+7${_model.textField121212TextController.text}',
                                msg: FFAppState().smsCode,
                              );

                              if ((_model.apiResultm0g?.succeeded ?? true)) {
                                context.pushNamed(
                                  SmsConfirmWidget.routeName,
                                  queryParameters: {
                                    'number': serializeParam(
                                      '+7${_model.textField121212TextController.text}',
                                      ParamType.String,
                                    ),
                                  }.withoutNulls,
                                );
