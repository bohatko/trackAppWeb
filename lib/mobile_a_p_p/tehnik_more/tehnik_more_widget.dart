...
import 'tehnik_more_model.dart';
export 'tehnik_more_model.dart';

class TehnikMoreWidget extends StatefulWidget {
  const TehnikMoreWidget({
    super.key,
    this.tehnikDoc,
    this.tehModeDoc,
    this.oborudDoc,
  ...
  final TehnikaRecord? tehnikDoc;
  final SpravochnikTekhnikaRecord? tehModeDoc;
  final DopOborudRecord? oborudDoc;

  static String routeName = 'Tehnik_more';
  static String routePath = 'tehnikMore';

  @override
  State<TehnikMoreWidget> createState() => _TehnikMoreWidgetState();
}

class _TehnikMoreWidgetState extends State<TehnikMoreWidget> {
  late TehnikMoreModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TehnikMoreModel());
