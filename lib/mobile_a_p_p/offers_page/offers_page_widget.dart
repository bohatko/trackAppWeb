...
class OffersPageWidget extends StatefulWidget {
  ...
  static String routeName = 'Offers_page';
  static String routePath = 'offersPage';
                  ...
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 30.0),
                      child: FutureBuilder<List<OffersRecord>>(
                        future: queryOffersRecordOnce(
                                  ...
                                  Padding(
                                    ...
                                    child: StreamBuilder<OrdersRecord>(
                                      stream: OrdersRecord.getDocument(
                                          listViewOffersRecord.parentReference),
                                      builder: (context, snapshot) {
                                        // Customize what your widget looks like when it's loading.
                                        if (!snapshot.hasData) {
                                          return Center(
                                        ...
                                        return InkWell(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Техника: ${columnOrdersRecord.tehnikaNaZakaz}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .labelMedium
                                                        .override(
                                                  ...
                                                  Align(
                                                    alignment:
                                                        AlignmentDirectional(
                                                            0.0, 0.0),
                                                    child: Text(
                                                      '${listViewOffersRecord.priceOffer.toString()} руб.',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .labelMedium
                                                          .override(
