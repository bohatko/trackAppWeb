...
class CreateCompanyWidget extends StatefulWidget {
  ...
  static String routeName = 'Create_company';
  static String routePath = 'createCompany';
...
class _CreateCompanyWidgetState extends State<CreateCompanyWidget> {
  ...
  void initState() {
    ...
    _model.yourNamelastTextController1 ??= TextEditingController();
    _model.yourNamelastFocusNode1 ??= FocusNode();
    ...
    _model.yourNamelastTextController2 ??= TextEditingController();
    _model.yourNamelastFocusNode2 ??= FocusNode();
                        ...
                        AuthUserStreamWidget(
                          builder: (context) => Text(
                            valueOrDefault(currentUserDocument?.category, '') ==
                                    'Исполнитель'
                                ? 'Чтобы принимать заказы - нужно заполнить данные компании, подписать договoр Оферты и добавить технику!'
                                : 'Чтобы добавлять заказы - нужно заполнить данные компании, подписать договoр Оферты!',
                              ...
                              Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 30.0, 0.0, 0.0),
                                  child: Lottie.asset(
                                    'assets/jsons/Animation_-_1706614613967.json',
                                    width: 150.0,
                                    height: 130.0,
                                    fit: BoxFit.contain,
                                    animate: true,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.yourNamelastTextController1,
                                  focusNode: _model.yourNamelastFocusNode1,
                                  textCapitalization: TextCapitalization.words,
                                  obscureText: false,
                                  decoration: InputDecoration(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (FFAppState().userRole == 'Исполнитель')
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                20.0, 0.0, 20.0, 16.0),
                            child: TextFormField(
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 20.0, 16.0),
                          child: TextFormField(
                            controller: _model.yourNamelastTextController2,
                            focusNode: _model.yourNamelastFocusNode2,
                            textCapitalization: TextCapitalization.words,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: 'ИНН',
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 20.0, 16.0),
                          child: TextFormField(
                            controller: _model.okpoTextController,
                            ...
                            buildCounter: (context,
                                    ...
                                    maxLength}) =>
                                null,
                            validator: _model.okpoTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                        Divider(
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            buildCounter: (context,
                                    ...
                                    maxLength}) =>
                                null,
                            validator: _model.cityTextController4Validator
                                .asValidator(context),
                          ),
                        ),
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            focusNode: _model.cityFocusNode5,
                            textCapitalization: TextCapitalization.words,
                            obscureText: false,
                            decoration: InputDecoration(
                            ...
                            buildCounter: (context,
                                ...
                                null,
                            keyboardType: TextInputType.number,
                            validator: _model.cityTextController5Validator
                                .asValidator(context),
                            inputFormatters: [
                              FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                            ],
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              20.0, 0.0, 20.0, 16.0),
                          child: TextFormField(
                            controller: _model.cityTextController6,
                            focusNode: _model.cityFocusNode6,
                            textCapitalization: TextCapitalization.words,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: 'Кореспондентский счёт',
                              labelStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'Roboto',
                            ...
                            buildCounter: (context,
                                ...
                                null,
                            keyboardType: TextInputType.number,
                            validator: _model.cityTextController6Validator
                                .asValidator(context),
                            inputFormatters: [
                              FilteringTextInputFormatter.allow(RegExp('[0-9]'))
                            ],
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: ((_model.yourNameTextController2.text !=
                                      null &&
                                  _model.yourNameTextController2.text != '') &&
                              (_model.cityTextController1.text != null &&
                          ...
                          : () async {
                              ...
                              await companyRecordReference
                                ...
                                companyInn:
                                    _model.yourNamelastTextController2.text,
                                companyKpp: _model.cityTextController1.text,
                                companyBank: _model.cityTextController3.text,
                                companyRs: _model.cityTextController5.text,
                                companyAdress:
                                    _model.yourNameTextController4.text,
                                companyBik: _model.cityTextController4.text,
                                gendir: _model.yourNameTextController2.text,
                                companyOkpo: _model.okpoTextController.text,
                                companyKs: _model.cityTextController6.text,
                                companyOrgn: _model.cityTextController2.text,
                              ));
                                  ...
                                  CompanyRecord.getDocumentFromData(
                                      createCompanyRecordData(
                                        companyName:
                                            _model.yourNameTextController3.text,
                                        companyInn: _model
                                            .yourNamelastTextController2.text,
                                        companyKpp:
                                            _model.cityTextController1.text,
                                        companyBank:
                                            _model.cityTextController3.text,
                                        companyRs:
                                            _model.cityTextController5.text,
                                        companyAdress:
                                            _model.yourNameTextController4.text,
                                        companyBik:
                                            _model.cityTextController4.text,
                                        gendir:
                                            _model.yourNameTextController2.text,
                                        companyOkpo:
                                            _model.okpoTextController.text,
                                        companyKs:
                                            _model.cityTextController6.text,
                                        companyOrgn:
                              ...
                              unawaited(
                                () async {
                                  await currentUserReference!
                                    ...
                                    lastName:
                                        _model.yourNamelastTextController1.text,
                                    docAfferta: false,
                                    companyRef:
                                        _model.createdCompany?.reference,
                                  ));
                                }(),
                              );
                              if (valueOrDefault<bool>(
                                ...
                                context.goNamed(OfertaPageWidget.routeName);
                              }
