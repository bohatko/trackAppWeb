...
import 'modal_add_new_tehnik_model.dart';
export 'modal_add_new_tehnik_model.dart';

class ModalAddNewTehnikWidget extends StatefulWidget {
  const ModalAddNewTehnikWidget({super.key});

  @override
  State<ModalAddNewTehnikWidget> createState() =>
      _ModalAddNewTehnikWidgetState();
}

class _ModalAddNewTehnikWidgetState extends State<ModalAddNewTehnikWidget> {
  late ModalAddNewTehnikModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModalAddNewTehnikModel());
