...
import 'bs_add_new_driver_model.dart';
export 'bs_add_new_driver_model.dart';

class BsAddNewDriverWidget extends StatefulWidget {
  const BsAddNewDriverWidget({super.key});

  @override
  State<BsAddNewDriverWidget> createState() => _BsAddNewDriverWidgetState();
}

class _BsAddNewDriverWidgetState extends State<BsAddNewDriverWidget> {
  late BsAddNewDriverModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BsAddNewDriverModel());
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(16.0, 4.0, 0.0, 20.0),
                    child: Text(
                      'Заполните все поля',
                                ...
                                await showDialog(
                                  ...
                                  builder: (alertDialogContext) {
                                    return AlertDialog(
                                      ...
                                      content: Text(
                                          'Ему нужно скачать приложение для водителя и зайти с номером телефона который вы указали!'),
                                      actions: [
                                        TextButton(
                                          onPressed: () =>
