                          ...
                          children: [
                            wrapWithModel(
                              ...
                              child: OrderCardWidget(
                                ...
                                priceOrder:
                                    orderDetailIsOrdersRecord.orderPrice,
                                discriptionOrder:
                                  ...
                                  child: Padding(
                                    ...
                                    child: wrapWithModel(
                                      ...
                                      child: TimelapsWidget(
                                        timeCreated: orderDetailIsOrdersRecord
                                            .lastEdited!,
                                        mess:
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (confirmDialogResponse) {
                                        ...
                                        _model.offer =
                                          ...
                                          parent: orderDetailIsOrdersRecord
                                              .reference,
                                        ...
                                        _model.comZak =
                                            await queryCompanyRecordOnce(
                                          parent:
                                              orderDetailIsOrdersRecord.owner,
                                          singleRecord: true,
                                        ).then((s) => s.firstOrNull);
                                        await Future.wait([
                                          Future(() async {
                                            try {
                                              final result = await FirebaseFunctions
                                                ...
                                                "docxTemplateUrl":
                                                    _model.esmIsp?.link,
                                                "companyadresIsp": _model
                                                    .compIsp?.companyAdress,
                                                "innIsp":
                                          ...
                                          () async {
                                            await NotificationRecord.collection
                                                ...
                                                .set(
                                                  ...
                                                  message:
                                                      'Исполнитель завершил работы по  заказу №${orderDetailIsOrdersRecord.orderNumber.toString()}! Вам нужно подтвердить выполнение!',
