                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Image.asset(
                        'assets/images/tradeboardVhTzGG_img-1024x461_(1).jpg',
                        width: 300.0,
                        height: 250.0,
                        fit: BoxFit.contain,
                      ).animateOnPageLoad(
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Lottie.asset(
                          'assets/jsons/Animation_-_1705153246973.json',
                          width: 200.0,
                          height: 200.0,
                          fit: BoxFit.contain,
                          animate: true,
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      40.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    'Я хочу арендовать технику, чтобы выполнить какую-то работу',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Roboto',
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(8.0),
                          border: Border.all(
                            color: FFAppState().signUpCategory == 'Исполнитель'
                                ? FlutterFlowTheme.of(context).primary
                                : FlutterFlowTheme.of(context).alternate,
                            width: 1.0,
                          ),
                              ...
                              Align(
                                ...
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      40.0, 0.0, 0.0, 0.0),
                                  child: Text(
                                    'У меня есть техника, я хочу сдать её в аренду ',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
                                          fontFamily: 'Roboto',
                    ...
                    Opacity(
                      opacity: FFAppState().signUpCategory != null &&
                              FFAppState().signUpCategory != ''
                          ? 1.0
                          : 0.5,
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: (FFAppState().signUpCategory == null ||
                                  FFAppState().signUpCategory == '')
                              ? null
                              : () async {
                                  if (FFAppState().signUpCategory != null &&
                                      FFAppState().signUpCategory != '') {
                                    context.pushNamed(LoginSmsWidget.routeName);
                                  } else {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          'Ошибка! Выберите роль!',
                                          style: TextStyle(
                                            color: FlutterFlowTheme.of(context)
                                                .secondaryBackground,
                                          ),
