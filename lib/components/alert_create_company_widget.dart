...
import 'alert_create_company_model.dart';
export 'alert_create_company_model.dart';

class AlertCreateCompanyWidget extends StatefulWidget {
  const AlertCreateCompanyWidget({
    super.key,
  ...
  @override
  State<AlertCreateCompanyWidget> createState() =>
      _AlertCreateCompanyWidgetState();
}

class _AlertCreateCompanyWidgetState extends State<AlertCreateCompanyWidget> {
  late AlertCreateCompanyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlertCreateCompanyModel());
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        valueOrDefault(
                                                    ...
                                                    '') ==
                                                'Исполнитель'
                                            ? 'Чтобы принимать заказы - нужно заполнить данные компании  и добавить технику!'
                                            : 'Чтобы добавлять заказы - нужно заполнить данные компании!',
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText:
                                                  'Ваш номер в формате: 9801234567',
                                              hintStyle:
                                                  FlutterFlowTheme.of(context)
                                                      .labelMedium
                                                      .override(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Flexible(
                                          child: TextFormField(
                                            controller: _model
                                                .yourLastNameTextController,
                                            focusNode:
                                                _model.yourLastNameFocusNode,
                                            onChanged: (_) =>
                                                EasyDebounce.debounce(
                                        ...
                                        Flexible(
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              controller: _model
                                                  .yourFirstNameTextController,
                                              focusNode:
                                                  _model.yourFirstNameFocusNode,
                                              onChanged: (_) =>
                                                  EasyDebounce.debounce(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  _model.createdCompany =
                                      CompanyRecord.getDocumentFromData(
                                          createCompanyRecordData(
                                            ...
                                            companyBank: _model
                                                .nameBankTextController.text,
                                            companyRs:
                                                _model.rsTextController.text,
                                            companyAdress: _model
                                  ...
                                  unawaited(
                                    () async {
                                      await currentUserReference!
                                        ...
                                        displayName: _model
                                            .yourLastNameTextController.text,
                                        lastName: _model
                                            .yourFirstNameTextController.text,
                                        docAfferta: false,
                                        companyRef:
                                  ...
                                  if (valueOrDefault<bool>(
                                          currentUserDocument?.docAfferta,
                                          false) ==
                                      true) {
